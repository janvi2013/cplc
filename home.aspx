...
<body>
   ...
   <div class="navbar navbar-default navbar-fixed-top menu-back">
        <div class="container">
            ...
            <div class="navbar-collapse collapse" >
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="home.aspx">HOME PAGE<i class="fa fa-folder-open-o"></i>
                            <span>welcome computer point</span>
              ...
              <span>replace this text</span>
                     ...
                     <li class="dropdown">
                        <a href="login.aspx">Admin Login<i class="fa fa-globe"></i>
    ...
    <div class="div-social-top">
        ...
        <i class="fa fa-globe "></i>E-mail:  computerpointkarnal@gmail.com   | <i class="fa fa-mobile "></i>Call: : +91 - 184 -4046975  |  <i class="fa fa-map-marker "></i>Country : INDIA &nbsp;
              <a href="#">
